...
function createMarkdown(deps) {
    ...
    document += 'The Splunk Cloud Auth library for JavaScript contains some libraries that were written by others, and are being redistributed as part of the library, under their respective open source licenses.\n';
