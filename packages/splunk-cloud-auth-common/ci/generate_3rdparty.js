...
function createMarkdown(deps) {
    ...
    document += 'The Splunk Developer Cloud Common Authentication Library for JavaScript contains some libraries that were written by others, and are being redistributed as part of this library, under their respective open source licenses.\n';
